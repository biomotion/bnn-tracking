...
class Covariance(object):
  ...
  '''
  def __init__(self, covariance_id, classname):
    if covariance_id == 2:
      self.num_states = 10 # with angular velocity
    else:
      self.num_states = 7
    ...
    if covariance_id == 0:
      ...
      P = {
        ...
        'VEHICLE':        [0.08900372, 0.09412005, 0.03265469, 1.00535696, 0.10912802, 0.02359175, 0.02455134 ,0,0,0],
        ...
        'PEDESTRIAN': [0.03855275, 0.0377111 , 0.02482115, 2.0751833 , 0.02286483, 0.0136347 , 0.0203149 ,0,0,0],
      ...
      Q = {
        ...
        'VEHICLE':        [1.58918523e-01, 1.24935318e-01, 5.35573165e-03, 9.22800791e-02, 0, 0, 0, 0,0,0],
        ...
        'PEDESTRIAN': [3.34814566e-02, 2.47354921e-02, 5.94592529e-03, 4.24962535e-01, 0, 0, 0, 0,0,0],
      ...
      R = {
        ...
        'VEHICLE':        [0.08900372, 0.09412005, 0.03265469, 1.00535696, 0.10912802, 0.02359175, 0.02455134],
